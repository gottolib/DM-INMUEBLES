  ...
  return (
    <section className="container-site py-16 sm:py-20">
      <div className="text-center max-w-xl mx-auto mb-12">
        <p className="texto-subtitulo text-xs uppercase tracking-[0.2em] font-semibold mb-2">Selección</p>
        <h2 className="texto-titulo text-3xl sm:text-4xl">Propiedades Destacadas</h2>
      </div>
